package io.izzel.arclight.mod.server;
...
public class BukkitRegistry {
    ...
    private static void loadEnchantments() {
        ...
        ArclightMod.LOGGER.info("Registered {} new enchantments", size - 37);
    }
    ...
    private static void loadPotions() {
        ...
        ArclightMod.LOGGER.info("Registered {} new potion effect types", size - 32);
    }
