...
import io.izzel.arclight.mixin.core.world.server.ServerWorldMixin;
...
public abstract class ServerMultiWorldMixin extends ServerWorldMixin {
    ...
    // @formatter:off
    @Shadow @Final @Mutable private ServerWorld delegate;
    @Shadow @Final @Mutable private IBorderListener borderListener;
    // @formatter:on
