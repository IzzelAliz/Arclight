package io.izzel.arclight.impl.mixin.v1_14.core.entity.boss;
...
public abstract class WitherEntityMixin_1_14 extends MobEntityMixin_1_14 {
    ...
    protected void updateAITasks() {
        if (this.getInvulTime() > 0) {
            ...
            if (j1 <= 0) {
                ...
                ExplosionPrimeEvent event = new ExplosionPrimeEvent(this.bridge$getBukkitEntity(), 7.0F, false);
                Bukkit.getPluginManager().callEvent(event);
                if (!event.isCancelled()) {
                    this.world.createExplosion((WitherEntity) (Object) this, this.posX, this.posY + (double) this.getEyeHeight(), this.posZ, event.getRadius(), event.getFire(), explosion$mode);
                }
