package io.izzel.arclight.impl.mixin.v1_14.core.world.storage;
...
@Mixin(MapData.class)
public abstract class MapDataMixin_1_14 implements MapDataBridge {
    ...
    public DimensionType bridge$dimension(int id, String suffix, String dir, BiFunction<World, DimensionType, ? extends Dimension> provider, boolean skyLight) {
        return new DimensionType(id, suffix, dir, provider, skyLight, null, null);
    }
}
