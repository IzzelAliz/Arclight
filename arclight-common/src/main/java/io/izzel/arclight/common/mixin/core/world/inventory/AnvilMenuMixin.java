...
public abstract class AnvilMenuMixin extends ItemCombinerMixin implements AnvilMenuBridge {
    ...
    public void createResult() {
        ...
        if (itemstack.isEmpty()) {
            ...
            boolean flag = false;
            if (!this.bridge$forge$onAnvilChange((AnvilMenu) (Object) this, itemstack, itemstack2, resultSlots, itemName, j, this.player))
                return;
            ...
            if (flag && !this.bridge$forge$isBookEnchantable(itemstack1, itemstack2)) itemstack1 = ItemStack.EMPTY;
